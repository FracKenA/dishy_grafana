...
STARLINK_DATABASE_USER="starlink"
STARLINK_DATABASE_PASSWORD="starlinkpass"

NETSTAT_DATABASE_USER="netstat"
NETSTAT_DATABASE_PASSWORD="netstatpass
...
INFLUXDB_NETSTAT_USERNAME=${ADMIN_USERNAME}

INFLUXDB_ADMIN_PASSWORD=${ADMIN_PASSWORD}
INFLUXDB_PWD=${ADMIN_PASSWORD}
INFLUXDB_NETSTAT_PASSWORD=${ADMIN_PASSWORD}
